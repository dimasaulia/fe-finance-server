...
export function AccountPickerField({
  ...
  return (
    <div className="mt-7">
      ...
      <button
        className="mt-2.5 flex w-full items-center gap-3 rounded-[20px] border border-border-subtle bg-surface p-3.5 text-left shadow-[0_6px_16px_-12px_rgba(6,78,59,0.25)] transition-transform active:scale-[0.98]"
        onClick={onToggle}
        type="button"
      >
        <span
